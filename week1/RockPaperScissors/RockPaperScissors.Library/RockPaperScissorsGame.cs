...
namespace RockPaperScissors.Library
{
    public class RockPaperScissorsGame
    {
        ...
        RandomStrategy _randStrat;
        AdaptiveStrategy _adaptStrat;

        List<string> roundResults = new List<string>();

        // constructor
        public RockPaperScissorsGame(IInputterOutputter io, RandomStrategy randStrat, AdaptiveStrategy adaptStrat)
        {
            _io = io;
            // we're using a principle called dependency inversion here
            _randStrat = randStrat;
            _adaptStrat = adaptStrat;
        ...
        public void PlayRound()
        {
            ...
            var computersMove = _randStrat.DecideMove(roundResults);
